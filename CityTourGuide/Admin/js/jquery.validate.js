...
(function ($) {
    ...
    $.extend($.validator, {
        ...
        messages: {
            ...
            username: "Please enter only characters",
            email: "Please enter a valid email address.",
            url: "Please enter a valid URL.",
            date: "Please enter a valid date.",
            dateISO: "Please enter a valid date (ISO).",
			time12: "Please enter a valid time.",
			...
			lessThan: "Please enter less than value.",
			greaterThan: "Please enter greater than same value.",
        ...
        methods: {
			...
			time12: function (value, element) {
                return this.optional(element) || /^(00|0[0-9]|1[012]):[0-5][0-9] ?((a|p)m|(A|P)M)$/.test(value);
            },
